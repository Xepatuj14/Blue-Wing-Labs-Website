    ...
    <>
      ...
      <section className="px-5 py-14 sm:px-6 lg:px-8 lg:py-18">
        <div className="mx-auto max-w-6xl">
          <AppCallout
            title="Explore this pattern in Blue Wing Labs."
            body={`Use Blue Wing Labs to keep ${fly.name} connected to category pages, related guides, and the calmer bench workflow the app is built around.`}
          />
        </div>
      </section>
      ...
      <section className="px-5 py-14 sm:px-6 lg:px-8 lg:py-18">
        <div className="mx-auto max-w-6xl">
          <SectionHeading eyebrow="Related flies" title="Keep the internal links moving." body="These related fly pages connect similar patterns, nearby categories, and next-step reading paths so the public library behaves like a real knowledge graph." />
          <ol className="mt-10 grid gap-5 md:grid-cols-2">
      ...
      <section className="px-5 pb-20 sm:px-6 lg:px-8 lg:pb-24">
        <div className="mx-auto max-w-6xl">
          <SectionHeading eyebrow="Related guides" title={`Guides that mention ${fly.name}.`} body="These guides connect the pattern back into broader beginner, trout, seasonal, and category-level decisions." />
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            {relatedGuides.map((guide) => (
              <GuideCard key={guide.slug} guide={guide} />
            ))}
