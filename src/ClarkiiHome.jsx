...
export default function ClarkiiHome() {
  ...
  usePageAnimations(
    ...
    {
      heroSequence: [
        '[data-motion="clarkii-eyebrow"]',
        '[data-motion="clarkii-title"]',
        '[data-motion="clarkii-copy"]',
        '[data-motion="clarkii-cta"]',
        '[data-motion="clarkii-visual"] [data-motion-item]',
      ],
    },
    [],
  );
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-[#f4f1e8] text-stone-900">
      ...
      <header className="sticky top-0 z-30 border-b border-stone-900/8 bg-[#f4f1e8]/92 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 sm:px-6 lg:px-8">
          ...
          <nav aria-label="Clarkii" className="hidden items-center gap-7 text-sm text-stone-700 md:flex">
            <a href={homeHref} className="motion-nav-link rounded-full px-2 py-1 transition hover:bg-white/75 hover:text-stone-950">
              Home
            </a>
            ...
            <a href="#about-clarkii" className="motion-nav-link rounded-full px-2 py-1 transition hover:bg-white/75 hover:text-stone-950">
              About Clarkii
            </a>
            <a href="#contact" className="motion-nav-link rounded-full px-2 py-1 transition hover:bg-white/75 hover:text-stone-950">
              Contact
            </a>
          </nav>
        </div>
      ...
      <main id="main-content">
        <section className="px-5 pb-14 pt-14 sm:px-6 lg:px-8 lg:pb-20 lg:pt-18">
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
            <div className="max-w-[36rem]">
              <p data-motion="clarkii-eyebrow" className="text-[0.74rem] font-semibold uppercase tracking-[0.34em] text-emerald-900">Clarkii Outdoors</p>
              <h1 data-motion="clarkii-title" className="mt-5 max-w-[11ch] font-serif text-[3.35rem] leading-[0.92] tracking-[-0.05em] text-stone-950 sm:text-[4.4rem] lg:text-[5rem]">
                Practical tools for anglers and outdoor creators.
              </h1>
              <p data-motion="clarkii-copy" className="mt-6 max-w-[34rem] text-[1.04rem] leading-7 text-stone-700 sm:text-[1.1rem] sm:leading-8">
              ...
              <p data-motion="clarkii-copy" className="mt-4 max-w-[32rem] text-[1rem] leading-7 text-stone-700">
              ...
              <div data-motion="clarkii-cta" className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a href={blueWingHomeHref} data-hover="lift" className="inline-flex items-center justify-center rounded-full bg-[#183227] px-6 py-3.5 text-sm font-semibold text-stone-50 shadow-[0_18px_40px_rgba(24,38,30,0.22)] transition hover:-translate-y-0.5 hover:bg-[#214031]" style={darkButtonStyle}>
                  Explore Blue Wing Labs
                </a>
                <a href="#contact" data-hover="lift" className="inline-flex items-center justify-center rounded-full border border-stone-900/10 bg-white/80 px-6 py-3.5 text-sm font-semibold text-stone-900 transition hover:-translate-y-0.5 hover:bg-white" style={lightButtonStyle}>
                  Contact Clarkii
                </a>
              </div>
            </div>

            <div data-motion="clarkii-visual" className="relative">
              ...
              <div className="relative grid gap-4 rounded-[2.4rem] border border-stone-900/8 bg-[linear-gradient(145deg,rgba(24,50,39,0.94),rgba(15,31,24,0.98))] p-5 shadow-[0_28px_75px_rgba(18,28,22,0.24)] lg:grid-cols-[0.78fr_1.22fr] lg:items-center">
                <div className="grid gap-4">
                  <div data-motion-item className="flex h-44 items-end rounded-[1.5rem] border border-white/10 bg-[linear-gradient(160deg,#314e3f_0%,#22382d_58%,#17271f_100%)] p-5 shadow-[0_18px_34px_rgba(10,16,12,0.24)]">
                    <div>
                  ...
                  <div data-motion-item className="rounded-[1.5rem] border border-white/10 bg-white/8 p-4 text-stone-50">
                ...
                <div data-motion-item className="rounded-[2rem] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-4">
        ...
        <section id="about-clarkii" className="px-5 pb-16 sm:px-6 lg:px-8 lg:pb-20">
          <div data-motion-group="about-cards" className="mx-auto grid max-w-6xl gap-5 md:grid-cols-3">
            {[
              ...
              <article key={title} data-motion-item data-hover="lift" className={`rounded-[1.7rem] border p-6 shadow-[0_16px_36px_rgba(35,40,25,0.05)] ${index === 1 ? "border-emerald-900/12 bg-[#e9f0e8]" : "border-stone-900/8 bg-white/82"}`}>
        ...
        <section className="bg-[#e9efe6] px-5 py-18 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-6xl">
            ...
            <div data-motion-group="featured-products" className="mt-10 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
              <article data-motion-item data-hover="lift" className="rounded-[2rem] border border-stone-900/8 bg-white/84 p-6 shadow-[0_22px_50px_rgba(32,38,28,0.08)] sm:p-8">
                <div className="grid gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
                  ...
                  <div>
                    ...
                    <a href={blueWingHomeHref} data-hover="lift" className="mt-6 inline-flex items-center justify-center rounded-full bg-stone-950 px-6 py-3.5 text-sm font-semibold text-stone-50 transition hover:-translate-y-0.5 hover:bg-stone-800" style={darkButtonStyle}>
                      Explore Blue Wing Labs
                    </a>
                  </div>
                </div>
              ...
              <article data-motion-item data-hover="lift" className="rounded-[2rem] border border-stone-900/8 bg-[linear-gradient(145deg,#1d3127_0%,#213b2f_100%)] p-6 text-stone-50 shadow-[0_22px_55px_rgba(24,38,30,0.22)] sm:p-8">
        ...
        <section id="contact" className="px-5 py-18 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-6xl rounded-[2.2rem] border border-stone-900/8 bg-[linear-gradient(135deg,#f6f2e8_0%,#e7ddc9_100%)] px-6 py-8 shadow-[0_28px_70px_rgba(35,40,25,0.1)] sm:px-8 lg:px-10">
            <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
              ...
              <div data-motion="reveal" data-hover="lift" className="rounded-[1.7rem] border border-stone-900/8 bg-white/80 p-6 shadow-[0_14px_36px_rgba(35,40,25,0.05)]">
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                  <a href={contactHref} data-hover="lift" className="inline-flex items-center justify-center rounded-full bg-[#183227] px-6 py-3.5 text-sm font-semibold text-stone-50 transition hover:-translate-y-0.5 hover:bg-[#214031]" style={darkButtonStyle}>
                  ...
                  <a href={blueWingHomeHref} data-hover="lift" className="inline-flex items-center justify-center rounded-full border border-stone-900/10 bg-white px-6 py-3.5 text-sm font-semibold text-stone-900 transition hover:-translate-y-0.5 hover:bg-stone-50" style={lightButtonStyle}>
