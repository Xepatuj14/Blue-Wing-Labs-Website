    ...
    >
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row">
        <button
          ...
          className="inline-flex items-center justify-center rounded-full bg-stone-950 px-6 py-3.5 text-sm font-semibold text-stone-50 transition hover:-translate-y-0.5 hover:bg-stone-800"
        >
      ...
      <header className="sticky top-0 z-30 border-b border-stone-900/8 bg-[#f5f1e8]/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <a
              href={downloadHref}
              className="inline-flex items-center justify-center rounded-full border border-stone-900/10 bg-stone-950 px-4 py-2.5 text-sm font-semibold text-stone-50 shadow-[0_10px_28px_rgba(18,21,17,0.16)] transition hover:-translate-y-0.5 hover:bg-stone-800"
            >
              Request Access
            </a>
          </div>
          ...
          <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
            <div className="max-w-[35rem]">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  href={downloadHref}
                  className="inline-flex items-center justify-center rounded-full bg-stone-950 px-6 py-3.5 text-sm font-semibold text-stone-50 shadow-[0_16px_36px_rgba(16,20,15,0.2)] transition hover:-translate-y-0.5 hover:bg-stone-800"
                >
                  Request App Access
                </a>
                <a
